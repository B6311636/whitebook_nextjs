...
interface SelectColorProps {
    ...
    removeImageFromState: (vlaue: ImageType) => void
...
const SelectColor: React.FC<SelectColorProps> = ({
    ...
    return (<div className="grid grid-cols-1 mdgrid-cols-1 overflow-y-auto border-b-[1.2px] border-slate-200 items-center p-2">
